    ...
    if ($reload){
        ...
        <tr><td align=right>".et('Lang').":<td>
            <select name=newlang id=newlang style=\"width:410px; padding:5px;\">
                ...
                <option value='ru'>Russian - by ??????? ?????, ??????? ????????</option>
                <option value='tr'>Turkish - by Necdet Yazilimlari</option>
                <option value='ua'>Ukrainian - by ?????? ??????</option>
            </select>
        </td></tr>
...
function et($tag){
    ...
    $et['pl']['Enter'] = 'Enter';
    $et['pl']['Send'] = 'Wyslij';
    $et['pl']['Refresh'] = 'Odswiez';
    $et['pl']['SaveConfig'] = 'Zapisz konfiguracje';
    ...
    $et['pl']['UploadEnd'] = 'Wgranie zakonczone';
    $et['pl']['Perm'] = 'Prawa pliku';
    $et['pl']['Perms'] = 'Prawa dostepu';
    $et['pl']['Owner'] = 'Wlasciciel';
    $et['pl']['Group'] = 'Grupa';
    $et['pl']['Other'] = 'Inne';
    $et['pl']['Size'] = 'Rozmiar';
    $et['pl']['Date'] = 'Data';
    ...
    $et['pl']['JSError'] = 'Blad JavaScript';
    $et['pl']['NoSel'] = 'Nie wybrano zadnych rekordów';
    $et['pl']['SelDir'] = 'Wybierz docelowy folder w drzewku po lewej';
    $et['pl']['TypeDir'] = 'Wpisz nazwe folderu';
    $et['pl']['TypeArq'] = 'Wpisz nazwe pliku';
    $et['pl']['TypeCmd'] = 'Wprowadz komende';
    $et['pl']['TypeArqComp'] = 'Wprowadz nazwe pliku.\\nRozszerzenie definiuje kompresje pliku.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $et['pl']['RemSel'] = 'USUN zanzaczone rekordy';
    $et['pl']['NoDestDir'] = 'Nie wybrano folderu docelowego';
    $et['pl']['DestEqOrig'] = 'Folder docelowy jest równy biezacemu folderowi';
    $et['pl']['InvalidDest'] = 'Folder docelowy jest niepoprawny';
    $et['pl']['NoNewPerm'] = 'Nie ustawiono uprawnien';
    $et['pl']['CopyTo'] = 'KOPIUJ do';
    $et['pl']['MoveTo'] = 'PRZENIES do';
    $et['pl']['AlterPermTo'] = 'ZMIEN PRAWA DOSTEPU do';
    $et['pl']['ConfExec'] = 'Potwierdz WYKONANIE POLECENIA';
    $et['pl']['ConfRem'] = 'Potwierdz USUNIECIE';
    $et['pl']['EmptyDir'] = 'Pusty folder';
    $et['pl']['IOError'] = 'Blad wejscia/wyjscia';
    $et['pl']['FileMan'] = 'PHP Menadzer plików';
    $et['pl']['InvPass'] = 'Niepoprawne haslo';
    $et['pl']['ReadDenied'] = 'Czytanie dostep zabroniony';
    $et['pl']['FileNotFound'] = 'Nie odnaleziono pliku';
    $et['pl']['AutoClose'] = 'Zamknij po zakonczeniu';
    $et['pl']['OutDocRoot'] = 'Plik powyzej DOCUMENT_ROOT';
    $et['pl']['NoCmd'] = 'Blad: Brak polecenia';
    $et['pl']['ConfTrySave'] = 'Plik bez mozliwosci zapisy.\\nSpróbój zapisac pomimo tego';
    $et['pl']['ConfSaved'] = 'Konfiguracja zapisana';
    $et['pl']['PassSaved'] = 'Haslo zapisane';
    $et['pl']['FileDirExists'] = 'Plik lub folder juz istnieje';
    $et['pl']['NoPhpinfo'] = 'Funkcja phpinfo wylaczona';
    $et['pl']['NoReturn'] = 'bez powrotu';
    $et['pl']['FileSent'] = 'Plik wyslano';
    $et['pl']['SpaceLimReached'] = 'Osiagnieto limit miejsa';
    $et['pl']['InvExt'] = 'Niepoprawne rozszerzenie';
    $et['pl']['FileNoOverw'] = 'Plik nie moze zostac nadpisany';
    $et['pl']['FileOverw'] = 'Nadpisano plik';
    $et['pl']['FileIgnored'] = 'Plik pominiete';
    $et['pl']['ChkVer'] = 'Sprawdz aktualizacje';
    $et['pl']['ChkVerAvailable'] = 'Jest nowa wersja, klikniu tutaj aby pobrac!!';
    $et['pl']['ChkVerNotAvailable'] = 'Brak nowszej wersji. :(';
    $et['pl']['ChkVerError'] = 'Blad polaczenia.';
    $et['pl']['Website'] = 'Strona';
    $et['pl']['SendingForm'] = 'Pliki sa przesylane, prosze czekac';
    $et['pl']['NoFileSel'] = 'Nie wybrano pliku';
    $et['pl']['SelAll'] = 'Wszystkie';
    $et['pl']['SelNone'] = 'Zadme';
    $et['pl']['SelInverse'] = 'Odwróc zaznaczenie';
    ...
    $et['pl']['Seconds'] = 'sec';
    $et['pl']['ErrorReport'] = 'Raportowanie bledów';
    $et['pl']['Close'] = 'Zamknij';
    $et['pl']['SetPass'] = 'Ustaw haslo';
    $et['pl']['ChangePass'] = 'Zmien haslo';
    ...
    $et['ko']['ChangePass'] = '???? ??';
    $et['ko']['Portscan'] = '????';
    $et['ko']['PHPOpenBasedir'] = '?? ??? ????';
    $et['ko']['PHPOpenBasedirFullAccess'] = '(???) ?? ?? ??';
    $et['ko']['About'] = '??';
    $et['ko']['FileSaved'] = '??? ??????';
    $et['ko']['FileSaveError'] = '?? ?? ? ??? ??????';
    $et['ko']['Timezone'] = '???';
    ...
    $et['ru']['To']='?';
    $et['ru']['Destination']='???????? ?????';
    $et['ru']['Configurations']='????????????';
    $et['ru']['JSError']='?????? JavaScript';
    $et['ru']['NoSel']='??? ????????? ?????????';
    $et['ru']['SelDir']='???????? ????? ?????????? ? ????? ??????';
    $et['ru']['TypeDir']='??????? ??? ?????';
    $et['ru']['TypeArq']='??????? ??? ?????';
    ...
    $et['ru']['FileNotFound']='???? ?? ??????';
    $et['ru']['AutoClose']='??????? ????? ?????????';
    $et['ru']['OutDocRoot']='????? ?? ????????? DOCUMENT_ROOT';
    $et['ru']['NoCmd']='??????: ??????? ?? ??????????????';
    $et['ru']['ConfTrySave']='???? ??? ???? ?? ??????.\\n?????????? ?????????';
    $et['ru']['ConfSaved']='???????????? ?????????';
    $et['ru']['PassSaved']='?????? ????????';
    $et['ru']['FileDirExists']='???? ??? ????? ??? ??????????';
    $et['ru']['NoPhpinfo']='??????? PHPInfo ?????????';
    $et['ru']['NoReturn']='??? ????????';
    $et['ru']['FileSent']='???? ?????????';
    $et['ru']['SpaceLimReached']='?????? ????????? ?????????';
    $et['ru']['InvExt']='???????????????? ??????????';
    $et['ru']['FileNoOverw']='???? ?? ????? ???? ???????????';
    $et['ru']['FileOverw']='???? ???????????';
    $et['ru']['FileIgnored']='???? ???????????';
    $et['ru']['ChkVer']='????? ??????????';
    $et['ru']['ChkVerAvailable']=' ???????? ????? ??????; ??????? ?????, ????? ?????? ????????!';
    $et['ru']['ChkVerNotAvailable']='?? ??????? ????? ??????.';
    $et['ru']['ChkVerError']='?????? ???????????.';
    $et['ru']['Website']='????';
    $et['ru']['SendingForm']='???????? ??????; ??????????, ?????????';
    $et['ru']['NoFileSel']='??? ????????? ??????';
    ...
    $et['cn']['To'] = '?';
    $et['cn']['Destination'] = '??';
    $et['cn']['Configurations'] = '??';
    $et['cn']['JSError'] = 'JavaScript ??';
    $et['cn']['NoSel'] = '?????';
    $et['cn']['SelDir'] = '?????????????';
    $et['cn']['TypeDir'] = '???????';
    $et['cn']['TypeArq'] = '?????';
    ...
    $et['cn']['FileNotFound'] = '?????';
    $et['cn']['AutoClose'] = '?????';
    $et['cn']['OutDocRoot'] = '???? DOCUMENT_ROOT';
    $et['cn']['NoCmd'] = '??: ??????';
    $et['cn']['ConfTrySave'] = '???-??-??.\\n????.';
    $et['cn']['ConfSaved'] = '????';
    $et['cn']['PassSaved'] = '????';
    $et['cn']['FileDirExists'] = '?????????';
    $et['cn']['NoPhpinfo'] = '?? phpinfo ???';
    $et['cn']['NoReturn'] = '???';
    $et['cn']['FileSent'] = '????';
    $et['cn']['SpaceLimReached'] = '??????';
    $et['cn']['InvExt'] = '?????';
    $et['cn']['FileNoOverw'] = '???????';
    $et['cn']['FileOverw'] = '????';
    $et['cn']['FileIgnored'] = '????';
    $et['cn']['ChkVer'] = '?????';
    $et['cn']['ChkVerAvailable'] = '????, ????????!!';
    $et['cn']['ChkVerNotAvailable'] = '???????. :(';
    $et['cn']['ChkVerError'] = '????.';
    $et['cn']['Website'] = '????';
    $et['cn']['SendingForm'] = '?????, ???...';
    $et['cn']['NoFileSel'] = '?????';
    ...
    $et['ua']['To']='?';
    $et['ua']['Destination']='??????? ????';
    $et['ua']['Configurations']='????????????';
    $et['ua']['JSError']='??????? JavaScript';
    $et['ua']['NoSel']='?? ?????? ??????? ????????';
    $et['ua']['SelDir']='???????? ???? ??????????? ? ?????? ???????';
    $et['ua']['TypeDir']='??????? ??\'? ????';
    $et['ua']['TypeArq']='??????? ??\'? ?????';
    ...
    $et['ua']['FileNotFound']='???? ?? ????????';
    $et['ua']['AutoClose']='??????? ????? ??????????';
    $et['ua']['OutDocRoot']='????? ?? ?????? DOCUMENT_ROOT';
    $et['ua']['NoCmd']='???????: ??????? ?? ?????????????';
    $et['ua']['ConfTrySave']='???? ??? ????? ?? ?????.\\n?????????? ????????';
    $et['ua']['ConfSaved']='???????????? ?????????';
    $et['ua']['PassSaved']='?????? ?????????';
    $et['ua']['FileDirExists']='???? ??? ???? ??? ?????';
    $et['ua']['NoPhpinfo']='??????? PHPInfo ????????';
    $et['ua']['NoReturn']='??? ?????????';
    $et['ua']['FileSent']='???? ?????????';
    $et['ua']['SpaceLimReached']='???\'??? ????????? ?????????';
    $et['ua']['InvExt']='?????????? ?????';
    $et['ua']['FileNoOverw']='???? ?? ???? ???? ?????????????';
    $et['ua']['FileOverw']='???? ?????????????';
    $et['ua']['FileIgnored']='???? ??????????';
    $et['ua']['ChkVer']='????? ??????????';
    $et['ua']['ChkVerAvailable']=' ???????? ???? ??????; ????????? ???, ??? ?????? ?????????!';
    $et['ua']['ChkVerNotAvailable']='?? ???????? ????? ??????.';
    $et['ua']['ChkVerError']='??????? ???????????.';
    $et['ua']['Website']='????';
    $et['ua']['SendingForm']='???????? ?????; ?????????, ???????';
    $et['ua']['NoFileSel']='??????? ?????';
    ...
    $et['fa']['FileNotFound'] = '???? ???? ???';
    $et['fa']['AutoClose'] = '???? ?? ???? ????? ???';
    $et['fa']['OutDocRoot'] = '???? ???? ?? DOCUMENT_ROOT';
    $et['fa']['NoCmd'] = '???: ????? ?????? ???';
    $et['fa']['ConfTrySave'] = '???? ???? ?????? ?????.\\n???? ???? ?????';
    $et['fa']['ConfSaved'] = '??????? ????? ????';
    $et['fa']['PassSaved'] = '??? ????? ??';
    $et['fa']['FileDirExists'] = '???? ?? ????? ????? ???';
    $et['fa']['NoPhpinfo'] = '???? phpinfo ??? ???? ???';
    $et['fa']['NoReturn'] = '???? ??????';
    $et['fa']['FileSent'] = '???? ????? ??';
    $et['fa']['SpaceLimReached'] = '?? ??????? ??? ????';
    $et['fa']['InvExt'] = '????? ??????';
    $et['fa']['FileNoOverw'] = '???? ????? ?????? ????? ?????';
    $et['fa']['FileOverw'] = '???? ?????? ????? ??';
    $et['fa']['FileIgnored'] = '???? ?? ??';
    $et['fa']['ChkVer'] = '????? ???? ????';
    $et['fa']['ChkVerAvailable'] = '???? ????, ???? ?????? ????? ???? ????!!';
    $et['fa']['ChkVerNotAvailable'] = '???? ???? ????? ??? ????. :(';
    $et['fa']['ChkVerError'] = '??? ?? ?????.';
    $et['fa']['Website'] = '??????';
    $et['fa']['SendingForm'] = '?? ??? ????? ???? ??, ???? ????? ?????';
    $et['fa']['NoFileSel'] = '??? ????? ?????? ????';
    ...
    $et['fa']['PHPOpenBasedirFullAccess'] = '(???? ????) ?????? ????';
    $et['fa']['About'] = '??????';
    $et['fa']['FileSaved'] = '???? ????? ??';
    $et['fa']['FileSaveError'] = '??? ?? ????? ????';
    ...
    $et['sr']['GetSize'] = 'dobivanje velicine';
    $et['sr']['Error'] = 'Greška';
    $et['sr']['Name'] = 'Ime';
    $et['sr']['And'] = 'i';
    $et['sr']['srter'] = 'srter';
    ...
    $et['sr']['SaveConfig'] = 'Sacuvaj konfiguraciju';
    //$et['sr']['SavePass'] = 'Save Password';
    //$et['sr']['TypePass'] = 'srter the password';
    $et['sr']['SaveFile'] = 'Sacuvaj datoteku';
    $et['sr']['Save'] = 'Sacuvaj';
    $et['sr']['Leave'] = 'Napusti';
    $et['sr']['Edit'] = 'Urediti';
    ...
    $et['sr']['TypeArqComp'] = 'srter the file name.\\nThe extsrsion ce definisati tip kompresije.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    ...
    $et['sr']['InvalidDest'] = 'Direktorijum odredišta nije vašeci';
    ...
    $et['sr']['InvPass'] = 'Nevažeca lozinka';
    $et['sr']['ReadDsried'] = 'Pristup citanju nije moguc';
    ...
    $et['sr']['ConfTrySave'] = 'Datoteka bez dozvole za pisanje.\\pokušajte ipak da je sacuvate';
    $et['sr']['ConfSaved'] = 'Konfiguracije su sacuvane';
    $et['sr']['PassSaved'] = 'Lozinka je sacuvana';
    $et['sr']['FileDirExists'] = 'Datoteka ili direktorijum vec postoje';
    $et['sr']['NoPhpinfo'] = 'Funkcija phpinfo je onemogucena';
    $et['sr']['NoReturn'] = 'nema povratka';
    $et['sr']['FileSsrt'] = 'Datoteka ssrt';
    $et['sr']['SpaceLimReached'] = 'Dostignuta ogranicenja prostora';
    $et['sr']['InvExt'] = 'Nevažeca extsrsion';
    ...
    $et['sr']['ChkVerAvailable'] = 'Nova verzija, kliknite ovde da zapocnete preuzimanje!!';
    $et['sr']['ChkVerNotAvailable'] = 'Nova verzija nije dostupna. :(';
    $et['sr']['ChkVerError'] = 'Greška u povezivanju.';
    $et['sr']['Website'] = 'Veb lokacija';
    $et['sr']['SsrdingForm'] = 'Ssrding datoteke , molim pricekajte';
    ...
    $et['sr']['About'] = 'O meni';
    $et['sr']['FileSaved'] = 'Datoteka je sacuvana';
    $et['sr']['FileSaveError'] = 'Greška prilikom cuvanja datoteke';
